...
Sur Window, dans la racine du projet
```bash
venv\Scripts\activate
```
```bash
...
Outil utile pour la syntaxe cron : https://crontab.guru/
...
Le fichier CSS doit être généré dans le dossier `assets`, sinon Dash ne le chargera pas.
