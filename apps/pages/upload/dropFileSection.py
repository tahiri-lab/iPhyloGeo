            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Upload(
                            id="upload-aligned-genetic-data",
                            className="upload-drag-drop",
                            children=html.Div(
                                [
                                    html.A(
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    "Don’t know where to starts ?", className="title"
                                ),
                                html.Div(
                                    "No worries, let’s try with some of our already made example.",
                    ...
                    id="upload-test-data",
                    className="helper primary",
                ),
                html.Button(
                    "Next", id="next-button", className="button actions", n_clicks=0
                ),
            ],
        ),
        # html.Div(children=[
...
clientside_callback(
    ...
    Output(
        "output-file-drop-position-next", "children"
    ),  # needed for the callback to trigger
