...
def _make_upload_zone(upload_id, label, file_types):
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(
                            "Select the type of data you'd like to include alongside the climatic dataset.",
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Span(
                            "Upload climatic and additional data to continue",
                            id="continue-tooltip",
